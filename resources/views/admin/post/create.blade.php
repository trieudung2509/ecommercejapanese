            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">Create Post</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <div class="custom-control custom-switch mb-3" dir="ltr">
                                                <input type="checkbox" class="custom-control-input" name="is_home" id="is_home" checked="">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input id="title-seo" name="title-seo" type="text" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="meta-key">Meta Keywords</label>
                                            <input id="meta-key" name="meta-key" type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label for="meta-des">Meta Description</label>
                                            <textarea class="form-control" id="meta-des" name="meta-des" rows="5"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
