                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="catePostName">Category Name <span class="required-star">*</span></label>
                                        <input id="catePostName" name="name" type="text" class="form-control" value="{{ old('name') }}" required >
                                        @if($errors->has('name'))
