                    ...
                    <div class="card-body">
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-8">
                                <div class="text-sm-right">
                                    <a href="{{ route('admin.cate_post.create') }}" class="btn btn-success btn-rounded waves-effect waves-light mb-2 mr-2"><i class="mdi mdi-plus mr-1"></i> Add Category</a>
                                </div>
                            </div><!-- end col-->
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-centered table-nowrap">
                                ...
                                <tbody>
                                    @if(isset($cate_post) && count($cate_post) > 0)
                                        @foreach ($cate_post as $key => $cate)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.cate_post.update',$cate->id) }}" class="mr-3 text-primary" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="mdi mdi-pencil font-size-18"></i></a>
