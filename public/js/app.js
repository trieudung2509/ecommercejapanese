! function(s) {
    ...
    function a(e) {
        "eng" == e ? document.getElementById("header-lang-img").src = "images/us.jpg" : "sp" == e ? document.getElementById("header-lang-img").src = "images/spain.jpg" : "gr" == e ? document.getElementById("header-lang-img").src = "images/germany.jpg" : "it" == e ? document.getElementById("header-lang-img").src = "images/italy.jpg" : "ru" == e && (document.getElementById("header-lang-img").src = "images/russia.jpg"), localStorage.setItem("language", e), null == (t = localStorage.getItem("language")) && a(n), s.getJSON("assets/lang/" + t + ".json", function(e) {
    ...
    function o(e) {
        1 == s("#light-mode-switch").prop("checked") && "light-mode-switch" === e ? (s("#dark-mode-switch").prop("checked", !1), s("#rtl-mode-switch").prop("checked", !1), s("#bootstrap-style").attr("href", "css/bootstrap.min.css"), s("#app-style").attr("href", "css/app.min.css"), sessionStorage.setItem("is_visited", "light-mode-switch")) : 1 == s("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e ? (s("#light-mode-switch").prop("checked", !1), s("#rtl-mode-switch").prop("checked", !1), s("#bootstrap-style").attr("href", "css/bootstrap-dark.min.css"), s("#app-style").attr("href", "css/app-dark.min.css"), sessionStorage.setItem("is_visited", "dark-mode-switch")) : 1 == s("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e && (s("#light-mode-switch").prop("checked", !1), s("#dark-mode-switch").prop("checked", !1), s("#bootstrap-style").attr("href", "css/bootstrap.min.css"), s("#app-style").attr("href", "css/app-rtl.min.css"), sessionStorage.setItem("is_visited", "rtl-mode-switch"))
    }
